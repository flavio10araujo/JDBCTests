...
public class JDBCResultSets {
    ...
    private static void selectAll(java.sql.Connection conn) throws SQLException {
        /**
         * Indicating result sets properties that will be created from this statement: type, concurrency and holdability.
         */
        ...
        /**
         * The database should have primary keys, if not following error will appear: 
         * Exception in thread "main" com.mysql.jdbc.NotUpdatable: Result Set not updatable (referenced table has no primary keys).
